...
import AddMovieModal from "../Videos/AddMovieModal";
import Loader from "../../../../utils/Loader";
import AddHighlightsModal from "./AddHighlightsModal";

export default function HighlightsTable({ data, columns }) {
      ...
      <div className="flex justify-between ">
        ...
        <div>
          <Modal
            ...
            Modal={<AddHighlightsModal setShowModal={setShowModal} />}
          >
...
function NotFound() {
  return (
    <h2 className="mx-auto text-center text-white text-xl my-5 font-semibold w-full">
      No video Found
    </h2>
  );
}
